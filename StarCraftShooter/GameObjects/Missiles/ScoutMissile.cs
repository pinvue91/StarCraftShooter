...
{
    public class ScoutMissile : IEnemyMissile
    {
        ...
        public ScoutMissile(Direction direction, int speed, int damage, int leftPosition, int topPosition, int width, int height)
        {
            Direction = direction;
            Speed = speed;
            Damage = damage;
