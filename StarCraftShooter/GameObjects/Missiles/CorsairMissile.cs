...
{
    public class CorsairMissile : IEnemyMissile
    {
        ...
        public CorsairMissile()
        {

        }

        public CorsairMissile(Direction direction, int speed, int damage, int leftPosition, int topPosition, int width, int height)
        {
            Direction = direction;
            Speed = speed;
            Damage = damage;
